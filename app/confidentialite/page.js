...
export default function Page() {
  return <LegalPage title="Politique de confidentialité" updated="10 septembre 2026">
    ...
    <section><h2 className="text-2xl font-black text-white">Prestataires</h2><p className="mt-2">La réservation peut passer par WhatsApp et le paiement par un prestataire sécurisé. Ces services appliquent leurs propres politiques de confidentialité.</p></section>
  </LegalPage>;
}
