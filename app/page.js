...
const copy = {
  fr: {
    ...
    benefits: [
      ...
      ["Chauffeur trilingue", "Français, néerlandais, anglais"], ["Paiement flexible", "Par carte, en espèces ou sur facture"],
    ],
  ...
  nl: {
    ...
    lead: "Boek in enkele ogenblikken. U krijgt een stipte chauffeur, een vaste prijs zonder commissie en ophaling overal in Brussel.",
    ...
    benefits: [["Gratis water", "Een fles water aan boord"], ["Gratis wifi", "Blijf verbonden"], ["Drietalige chauffeur", "Frans, Nederlands en Engels"], ["Flexibel betalen", "Met kaart, contant of op factuur"]],
    ...
    coverageTitle: "Ophaling in de 19 gemeenten van Brussel", coverageText: "Bij u thuis, uw hotel, station, kantoor of de luchthaven.", finalTitle: "Een chauffeur nodig?", finalText: "Bel ons of dien uw reservatieaanvraag online in.",
  ...
  en: {
    ...
    benefits: [["Complimentary water", "A bottle of water on board"], ["Free Wi-Fi", "Stay connected"], ["Trilingual driver", "French, Dutch and English"], ["Flexible payment", "By card, in cash or by invoice"]],
